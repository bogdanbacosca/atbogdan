...
export const projects: Project[] = [
  ...
  {
    slug: "comenzi-app",
    domain: "ordermanagement-react-app.vercel.app",
    url: "https://ordermanagement-react-app.vercel.app/",
    year: "2025",
    role: "Programare · UI/UX · Bază de date",
    image: "/projects/comenzi.png",
    services:
      "Aplicație web completă React, backend Supabase (PostgreSQL), autentificare, gestiune statusuri, integrare WhatsApp, design responsive",
    description:
      "Comenzi este o aplicație modernă de gestionare a comenzilor, construită cu React și Supabase. Permite operatorilor să administreze comenzile, să urmărească progresul statusurilor (atribuită → în producție → gata → livrată), să atribuie sarcini, să gestioneze clienți și articole și să comunice cu clienții direct prin integrarea WhatsApp.",
    highlights: [
      "Panou principal cu statistici: comenzi întârziate, atribuite, finalizate, de livrat azi și livrate azi",
      "Flux de statusuri complet, cu urmărirea progresului fiecărei comenzi",
      "Gestionare clienți, articole și comenzi fixate, cu căutare globală, filtre, sortare și paginare",
      "Atașamente de fișiere per comandă, stocate sigur în Supabase Storage",
      "Integrare WhatsApp, pentru confirmări și remindere trimise direct din aplicație",
      "Autentificare securizată cu Supabase Auth și securitate la nivel de rând (RLS)",
      "Design responsive, cu animații fluide realizate în Framer Motion",
    ],
    result:
      "O aplicație full-stack funcțională, gândită generic pentru orice tip de afacere mică — de la tipografii și service-uri auto, la programări și comenzi pentru evenimente — care aduce clienții, comenzile, termenele limită, plățile și comunicarea pe WhatsApp într-un singur loc.",
  },
  {
